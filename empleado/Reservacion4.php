  ...
  <header class="container-fluid bg-dark position-sticky top-0">
    <ul class="nav nav-pills mb-3 py-3 container" id="pills-tab" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <a class="nav-link active" id="pills-profile-tab" href="Cafeteria_4.php" role="tab"
    ...
    <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
      ...
      <div class="col d-flex justify-content-center mb-4">
        <div class="card shadow mb-1 bg-ligth rounded" style="width: 20rem;">
          ...
          <div class="card-body">
            <p class="card-text text-black-50 description">Crujientes papas fritas doradas y sazonadas a la perfección.
            </p>
      ...
      <div class="col d-flex justify-content-center mb-4">
        <div class="card shadow mb-1 bg-ligth rounded" style="width: 20rem;">
          ...
          <div class="card-body">
            <p class="card-text text-black-50 description">Refrescantes bebidas carbonatadas en una variedad de sabores.
            </p>
            <h5 class="text-primary">Precio: <span class="precio">$ 1.00</span></h5>
            <div class="d-grid gap-2">
              <button class="btn btn-primary button">Reservar</button>
