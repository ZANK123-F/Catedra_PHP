...
<body>
  <header class="container-fluid bg-dark position-sticky top-0">
    <ul class="nav nav-pills mb-3 py-3 container" id="pills-tab" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <a class="nav-link" href="Reservacion3.php" role="tab" aria-controls="reserva" aria-selected="false">Reservar
      ...
      <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
        ...
        <div class="col d-flex justify-content-center mb-4">
          <div class="card shadow mb-1 bg-ligth rounded" style="width: 20rem;">
            ...
            <div class="card-body">
              <p class="card-text text-black-50 description">Un delicioso conjunto de alimentos que te prepararán para
        ...
        <div class="col d-flex justify-content-center mb-4">
          <div class="card shadow mb-1 bg-ligth rounded" style="width: 20rem;">
            ...
            <div class="card-body">
              <p class="card-text text-black-50 description">Un clásico favorito que combina sabores y texturas en cada
                bocado.
                Este sándwich está relleno de ingredientes frescos y deliciosos, perfecto para un almuerzo rápido o un
                refrigerio satisfactorio..</p>
        ...
        <div class="col d-flex justify-content-center mb-4">
          <div class="card shadow mb-1 bg-ligth rounded" style="width: 20rem;">
            ...
            <div class="card-body">
              <p class="card-text text-black-50 description">Un plato reconfortante que te hará sentir como en casa. Con
                sabrosos trozos de pollo,
                verduras frescas y un caldo aromático, esta sopa es ideal para calentar el cuerpo y el alma en cualquier
                día.</p>
        ...
        <div class="col d-flex justify-content-center mb-4">
          <div class="card shadow mb-1 bg-ligth rounded" style="width: 20rem;">
            ...
            <div class="card-body">
              <p class="card-text text-black-50 description">Un festín de capas de pasta, salsa de tomate, carne y queso
                derretido. E
        ...
        <div class="col d-flex justify-content-center mb-4">
          <div class="card shadow mb-1 bg-ligth rounded" style="width: 20rem;">
            ...
            <div class="card-body">
              <p class="card-text text-black-50 description">Una jugosa y tierna pieza de carne asada, sazonada a la
                perfección y lista para ser disfrutada.
        ...
        <div class="col d-flex justify-content-center mb-4">
          <div class="card shadow mb-1 bg-ligth rounded" style="width: 20rem;">
            ...
            <div class="card-body">
              <p class="card-text text-black-50 description">: Una hamburguesa clásica con una jugosa carne de res,
                lechuga fresca, tomate, cebolla y queso derretido,
                todo ello servido entre dos suaves panes de hamburguesa. Un favorito de todos los tiempos que nunca
                defrauda.</p>
        ...
        <div class="col d-flex justify-content-center mb-4">
          <div class="card shadow mb-1 bg-ligth rounded" style="width: 20rem;">
            ...
            <div class="card-body">
              <p class="card-text text-black-50 description">Deliciosas y crujientes papas fritas doradas a la
                perfección y sazonadas con sal.
                Estas papas fritas son el acompañamiento perfecto para cualquier comida o simplemente como un sabroso
                tentempié.</p>
        ...
        <div class="col d-flex justify-content-center mb-4">
          <div class="card shadow mb-1 bg-ligth rounded" style="width: 20rem;">
            ...
            <div class="card-body">
              <p class="card-text text-black-50 description">Una selección de frutas frescas y coloridas que satisfarán
                tus antojos de algo dulce y refrescante.
                Desde manzanas hasta fresas y piñas, esta opción es ideal para aquellos que buscan una opción saludable
                y deliciosa.</p>
